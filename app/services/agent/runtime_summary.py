...
from app.services.infra.confidence import confidence_from_verification_report, confidence_payload
...
def build_runtime_summary(
    *,
    ...
    contract_context = {
        ...
        "target_aliases": contract_note_values(contract, prefix="target_alias="),
    ...
    summary = {
        "intent": {
            "kind": contract_note_value(contract, prefix="intent_kind=") or intent_kind_from_contract(contract),
            "confidence": contract_note_float(contract, prefix="intent_confidence="),
            ...
            "topic_state": topic_state,
            "active_topic": contract_note_value(contract, prefix="active_topic="),
        },
        "tool_loop": {
            "mode": "react_loop",
