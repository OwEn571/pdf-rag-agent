...
from app.services.contracts.context import contract_note_float, contract_note_values, contract_notes
...
def confidence_from_contract(contract: QueryContract) -> Confidence:
    ...
    explicit_score = contract_note_float(contract, prefix="intent_confidence=")
...
def coerce_claim_confidence(value: Any) -> float:
